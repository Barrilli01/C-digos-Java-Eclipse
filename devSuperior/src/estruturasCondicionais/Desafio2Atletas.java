...
public class Desafio2Atletas {
	...
	public static void main(String[] args) {
		...
		if (total > 0) {
			...
			System.out.println("O peso médio dos atletas é " + pmedio + "kg");
			System.out.println("O atleta mais alto é " + nomeMaior);
			...
			if (f > 0) {
				System.out.println("Altura média das mulheres: " + alturaMedF);
			} else {
			...
			System.out.println("Não existem atletas para serem cadastrados!");
		}
	}
